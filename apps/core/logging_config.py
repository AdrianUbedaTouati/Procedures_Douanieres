...
class ChatLogger:
    ...
    def log_reviewer_response(self, raw_response: str, parsed_result: Dict):
        ...
        self.logger_simple.info("-" * 80)
        self.logger_simple.info(f"Score: {parsed_result.get('score', 0)}/100 (informativo)")
        self.logger_simple.info(f"Continue improving: {parsed_result.get('continue_improving', True)}")
