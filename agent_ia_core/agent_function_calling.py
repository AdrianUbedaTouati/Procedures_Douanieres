...
class FunctionCallingAgent:
    ...
    def _prepare_messages(
        ...
        system_prompt_parts.extend([
            ...
            "- SIEMPRE formatea tus respuestas usando markdown correcto y estético",
            "- Usa ### para títulos principales de licitaciones, #### para subtítulos",
            "- Usa **texto** para negrita en datos importantes (presupuestos, fechas, nombres, IDs)",
            "",
            "REGLAS PARA LISTAS:",
            "- Usa listas numeradas (1. 2. 3.) SOLO para enumerar pasos ordenados o razones priorizadas",
            "- Usa viñetas (- item) para información de licitaciones, características, requisitos, o cualquier listado NO secuencial",
            "- NO uses listas numeradas para enumerar múltiples licitaciones",
            ...
            "```",
            "He encontrado algunas licitaciones relevantes para tu empresa:",
            "",
            ...
            "",
            "### Licitación: Modernización Sistema Gestión",
            "",
            "- **ID:** 00234567-2025",
            ...
            "- **Plazo:** 2025-12-15",
            "",
            "#### Razones para priorizar la primera licitación:",
            "",
            "1. **Alto presupuesto** - Con €1.5M, justifica el esfuerzo de preparar una oferta completa",
            "2. **CPV alineado** - El código CPV coincide perfectamente con tu especialización",
            "3. **Ubicación favorable** - Madrid está dentro de tus regiones preferidas",
            "",
            "¿Necesitas más detalles sobre alguna de estas licitaciones?",
            "```",
            "",
            "Ejemplo de respuesta INCORRECTA (NO hagas esto):",
            "```",
            "He encontrado estas licitaciones: 1. Licitación ID: 123 Organismo: X Presupuesto: €1M 2. Licitación ID: 456 Organismo: Y Presupuesto: €800K",
            "```"
        ])
